...
public class HttpRequest {
	 ...
	 * 例如：
	 *	/myweb/index.xml   不带参数
	 *	/myweb/reg？name=xxx&pwd=xxx。。。   带参数
	 * 所以对于url内容而言，我们再定义两个属性，分别保存url中的请求部分于参数部分。
	 */
	 ...
	 * @throws EmptyRequestException 
	 */
	private void parseRequestsLine() throws EmptyRequestException {
	...
	private void parseHeaders() {
		 ...
		 * 		则表示单独读取到了CRLF，那么就停止循环，因
		 * 		为所有消息头均读取完毕。
		 * 2：每当读取一行字符串后，要按照":"拆分为两项
		 * 		第一项为消息头名字，第二项为消息头的值
